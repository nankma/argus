...
Full setup, networking, and secrets configuration: **[deployment-plan.md](docs/deployment-plan.md)**.
...
| [observability-and-debugging](docs/observability-and-debugging.md) | Diagnosing the live service; querying traces |
| [security-plan](docs/security-plan.md) | Security review — findings, what's fixed, what's outstanding |
| [deployment-plan](docs/deployment-plan.md) | Cloud setup, CD design, deployment workflow |
| [telemetry-and-testing-plan](docs/telemetry-and-testing-plan.md) | Test strategy and telemetry design |
| [guardrails-plan](docs/guardrails-plan.md) | Four-layer safety design and reliability measurements |
| [context-management-plan](docs/context-management-plan.md) | Layered prompt design and the router |
| [bot-features-plan](docs/bot-features-plan.md) | Feature designs — built and planned |
| [ai-news-sources](docs/ai-news-sources.md) | Source registry; how to add one |

**Deferred by decision, with reasoning recorded:**

| Doc | Decision |
|---|---|
| [multi-channel-plan](docs/multi-channel-plan.md) | LINE support — on hold; its free tier caps push at 200/month account-wide |
| [data-layer-plan](docs/data-layer-plan.md) | Moving off SQLite — deferred until a second host actually needs the data |
| [model-portability-plan](docs/model-portability-plan.md) | Dynamic model switching — no gateway service needed; the injection seam already exists |

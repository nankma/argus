...
WORKDIR /app
COPY --chown=$MAMBA_USER:$MAMBA_USER agent.py news_sources.py bot.py admin_bot.py combined_bot.py telemetry_monitor.py guardrails.py users_db.py docker-entrypoint.sh ./
